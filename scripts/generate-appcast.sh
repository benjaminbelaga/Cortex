...
#     Cortex-1.0.0.zip 1.0.0 https://github.com/benjaminbelaga/Cortex/releases/download/v1.0.0/Cortex-1.0.0.zip
...
<rss version="2.0" xmlns:sparkle="http://www.andymatuschak.org/xml-namespaces/sparkle" xmlns:dc="http://purl.org/dc/elements/1.1/">
  <channel>
    <title>Cortex Updates</title>
    <link>https://benjaminbelaga.github.io/Cortex/appcast.xml</link>
    <description>Most recent updates for Cortex</description>
