...
extension NSTouchBarItem.Identifier {
    public static let touchBarSummary = NSTouchBarItem.Identifier("fr.yoyaku.cortex.touchbar.summary")
    public static let touchBarProviders = NSTouchBarItem.Identifier("fr.yoyaku.cortex.touchbar.providers")
    public static let touchBarRefresh = NSTouchBarItem.Identifier("fr.yoyaku.cortex.touchbar.refresh")
    public static let touchBarSettings = NSTouchBarItem.Identifier("fr.yoyaku.cortex.touchbar.settings")
}
