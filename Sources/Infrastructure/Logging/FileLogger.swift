...
/// File-based logger that writes to ~/Library/Logs/Cortex/Cortex.log
...
public final class FileLogger: @unchecked Sendable {
    ...
    private let queue = DispatchQueue(label: "fr.yoyaku.cortex.FileLogger")
    ...
    private init() {
        ...
        self.fileURL = logsDir.appendingPathComponent("Cortex.log")
    }
